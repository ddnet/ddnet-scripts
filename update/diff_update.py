...
Diff two DDNet release archives to obtain an update description.
...
""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    pairs = [
        ("DDNet-{}-win32".format(args.version1), "DDNet-{}-win32".format(args.version2)),
        ("DDNet-{}-win64".format(args.version1), "DDNet-{}-win64".format(args.version2)),
        ("DDNet-{}-linux_x86".format(args.version1), "DDNet-{}-linux_x86".format(args.version2)),
        ("DDNet-{}-linux_x86_64".format(args.version1), "DDNet-{}-linux_x86_64".format(args.version2))
    ]
