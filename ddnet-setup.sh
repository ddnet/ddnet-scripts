...
# On CHN servers:
# From another CHN server: tar cfz chn.tar.gz types/*/flexvotes.cfg types/*/flexname.cfg announcement.txt ddrace_local_auths.cfg
# tar xvf chn.tar.gz
