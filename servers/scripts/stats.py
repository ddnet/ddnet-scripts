...
# Total
tableCountries += "<tr style=\"border-top: .5em solid transparent;\"><td style=\"text-align: right;\"><strong>Total</strong></td><td style=\"text-align: right;\">%.2f</td><td style=\"text-align: right;\">%s</td><td style=\"text-align: right;\">%.2f</td><td style=\"text-align: right;\">%s</td><td style=\"text-align: right;\"><a href=\"2764/\">%d&nbsp;at&nbsp;%s</a></td><td style=\"text-align: right;\"><a href=\"/players/\">%s</a></td><td style=\"text-align: right;\"><a href=\"/ranks/\">%s</a></td>" % (sumPlayersDay, changeStr(sumPlayersDay, sumPlayersLastDay), sumPlayersWeek, changeStr(sumPlayersWeek, sumPlayersLastWeek), countryRecords["Total"][0], countryRecords["Total"][1].replace(" ", "&nbsp;"), nrPlayers["Total"], nrRanks["Total"])
