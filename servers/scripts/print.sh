...
#date1=$(date +"%s")
#date2=$(date -d "2014-09-21 20:01 CEST" +"%s")
#diff=$(($date2-$date1))
#
#if [ $diff -lt 0 ]; then
#  exit
...
#  sleep 7
#  echo "broadcast \"New awesome moderate map! More info on ddnet.tw\"" > /home/teeworlds/servers/servers/*fifo
#fi

echo "broadcast \"DDNet Moderate Tournament on Sunday, 20:00 CEST!\"" > /home/teeworlds/servers/servers/*fifo
sleep 7
echo "broadcast \"Great new map by Welf! More info on ddnet.tw\"" > /home/teeworlds/servers/servers/*fifo
