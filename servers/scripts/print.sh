...
date1=$(date +"%s")
date2=$(date -d "2017-03-19 20:01 CET" +"%s")
diff=$(($date2-$date1))
...
#  sleep 7
#  echo "broadcast \"Brutal map Aviate by SickCunt & [A] Awesome at 20:00 CEST!\"" > /home/teeworlds/servers/servers/*fifo
#  sleep 7
...
#  echo "broadcast \"Birthday Brutal Tournament in $(($diff / 60)) minutes!\"" > /home/teeworlds/servers/servers/*fifo
#  #sleep 7
...
#  echo "broadcast \"Moderate Tournament in $(($diff / 3600)) hours (20:00 CEST)\"" > /home/teeworlds/servers/servers/*fifo
#  sleep 7
#  echo "broadcast \"Noovice! by TyxpekCZ, 2 hours to get best time\"" > /home/teeworlds/servers/servers/*fifo
#fi

echo "broadcast \"Pros vs Team 0 Tournament on Sunday at 20:00 CET!\"" > /home/teeworlds/servers/servers/*fifo
sleep 7
echo "broadcast \"More info on DDNet.tw, tell your friends and have fun!\"" > /home/teeworlds/servers/servers/*fifo
