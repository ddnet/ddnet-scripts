...
date1=$(date +"%s")
date2=$(date -d "2021-01-24 20:01 CET" +"%s")
diff=$(($date2-$date1))

#if [ $diff -lt 0 ]; then
#  exit
#elif [ $(($diff / 60)) -lt 10 ]; then
#  echo "broadcast \"Race Tournament in $(($diff / 60)) minutes!\"" > /home/teeworlds/servers/servers/*fifo
#  #sleep 7
...
#  echo "broadcast \"Race Tournament in $(($diff / 3600)) hours (20:00 CET)\"" > /home/teeworlds/servers/servers/*fifo
#  #sleep 7
#  #echo "broadcast \"\"" > /home/teeworlds/servers/servers/*fifo
#fi

echo "broadcast \"Knux Tournament Sunday 20:00 CET!\"" > /home/teeworlds/servers/servers/*fifo
sleep 7
echo "broadcast \"Solo Race map by Knuski, best time after 90 min wins\"" > /home/teeworlds/servers/servers/*fifo
