...
print header("Tournament #4 - DDraceNetwork", menuText, "")
...
print '<div id="global" class="block div-tournament"><h2>Tournament #4</h2>'
print '<p>This tournament runs from 2013-12-08 to 2013-12-22.<br/>The player with the best team records on these maps wins!</p>'
