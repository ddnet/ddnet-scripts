...
#sleep 2
#echo 'sv_name "DDNet GER - Teleport Gun Event #5 [DDraceNetwork]"
...
#sleep 2
#echo 'sv_name "DDNet FRA - Teleport Gun Event #2 [DDraceNetwork]"
#exec motd/tournament.cfg
#sv_team 1
#sv_show_others_default 0
#sv_map_vote 0
...
#sleep 2
#echo 'sv_name "DDNet FRA - Teleport Gun Event #3 [DDraceNetwork]"
#exec motd/tournament.cfg
#sv_team 1
#sv_show_others_default 0
#sv_map_vote 0
...
#echo 'sv_name "DDNet GER - Teleport Gun Event #6 [DDraceNetwork]"
#exec motd/tournament.cfg
#sv_team 1
#sv_show_others_default 0
#sv_map_vote 0
